...
class FirebaseLogin {
    ...
    protected void launchLogin(
        ...
        credentialManager.getCredentialAsync(act.getBaseContext(),
                request,
    ...
    private void handleSignIn(Credential credential, Consumer<AuthResult> onSuccess, Consumer<Exception> onException) {
        if (credential instanceof CustomCredential customCredential
            ...
            AuthCredential firebaseCred = GoogleAuthProvider.getCredential(googleIdTokenCredential.getIdToken(), null);
