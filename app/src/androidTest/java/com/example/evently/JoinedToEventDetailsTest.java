...
import com.example.evently.ui.entrant.JoinedEventsFragment;
...
public class JoinedToEventDetailsTest extends EmulatedFragmentTest<JoinedEventsFragment> {
    ...
    public static void setupEvents() throws ExecutionException, InterruptedException {
        ...
        eventsDB.unsafeEnroll(
                        mockEvents[0].eventID(), FirebaseEmulatorTest.defaultMockAccount.email())
                .await();
    }
    ...
    @Override
    protected Class<JoinedEventsFragment> getFragmentClass() {
        return JoinedEventsFragment.class;
    }
}
